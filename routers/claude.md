...
- Load local workflow skills on demand: `task-setup`, `gathering-context`, `writing-specs`, `execution-mode`, `verifying-changes`, `independent-review`, `ci-recovery`, `handoff`, `notify-human`.
...
- Repo `CLAUDE.md`/`AGENTS.md` and current user instructions override local workflow lore.
